...
function Modal({ isOpen, onClose, editProduct, refreshProducts }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editProduct) {
        // Update product
        await axios.put(`https://figma-backend-dzfn.onrender.com/api/cart/${editProduct._id}`, formData);
      } else {
        // Add product
        await axios.post("https://figma-backend-dzfn.onrender.com/api/cart", formData);
      }
      refreshProducts();
      onClose();
    } catch (err) {
